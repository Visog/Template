	...
	<div id="container">
		<div class="sidebar">
			<ul id="nav">
				...
				<li class="child"><a href="/visog-job-portal-ui/specilization">specialization</a></li>
				...
				<li class="child"><a href="/visog-job-portal-ui/jobroles">job Role</a></li>
				...
				<li class="child"><a href="/visog-job-portal-ui/adress">address</a></li>
				...
				<li class="child"><a href="/visog-job-portal-ui/postjobdomains">post Job Domains</a></li>
